...
const api = {
    ...
    async safeGenerate(prompt, fallbackGenerator) {
        try {
            return await this.callParentApi(prompt);
        } catch (e) {
            utils.logError('API failed, using fallback', e);
            return typeof fallbackGenerator === 'function' ? fallbackGenerator() : fallbackGenerator;
        }
    }
};
...
const ui = {
            ...
            <div id="toolbox-svg-container" class="${compactClass}" style="width: 100%; height: 133px; position: relative; margin-bottom: 0;">
                <svg id="toolbox-svg" width="100%" height="100%" viewBox="0 0 800 133" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="main-view">
                        ...
                        <g id="btn-gen3" class="svg-btn" transform="translate(12, 34)">
                        ...
                        <g id="btn-worldbook" class="svg-btn" transform="translate(96, 34)">
                            <rect x="0" y="0" width="76" height="28" rx="5" fill="url(#btnGradient)" stroke="rgba(180,130,200,0.6)" stroke-width="1" filter="url(#shadow)"/>
                        ...
                        <g id="btn-summary" class="svg-btn" transform="translate(180, 34)">
                            <rect x="0" y="0" width="76" height="28" rx="5" fill="url(#btnGradient)" stroke="rgba(180,130,200,0.6)" stroke-width="1" filter="url(#shadow)"/>
                        ...
                        <g id="btn-analysis" class="svg-btn" transform="translate(264, 34)">
                            <rect x="0" y="0" width="76" height="28" rx="5" fill="url(#btnGradient)" stroke="rgba(180,130,200,0.6)" stroke-width="1" filter="url(#shadow)"/>
                        ...
                        <g id="btn-suggestion" class="svg-btn" transform="translate(348, 34)">
                            <rect x="0" y="0" width="76" height="28" rx="5" fill="url(#btnGradient)" stroke="rgba(180,130,200,0.6)" stroke-width="1" filter="url(#shadow)"/>
                        ...
                        <g id="btn-settings" class="svg-btn" transform="translate(760, 3)">
                    ...
                    <g id="detail-view" style="display: none;">
                        ...
                        <g id="btn-back" class="svg-btn" transform="translate(8, 3)">
        ...
        return `
            <div style="position: absolute; top: 30px; left: 0; right: 0; bottom: 0; padding: 10px; overflow: hidden; pointer-events: auto;">
                <div style="display: flex; gap: 10px; align-items: center; margin-bottom: 8px;">
                    ...
                    <button id="gen-start-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.7); border-radius: 5px; padding: 5px 14px; font-size: 11px; font-weight: 600; cursor: pointer; flex: 1; transition: all 0.2s;">生成</button>
                </div>
                <div id="gen-results" style="max-height: 70px; overflow-y: auto; flex: 1;"></div>
            </div>
        `;
    },
        ...
        return `
            <div style="position: absolute; top: 30px; left: 0; right: 0; bottom: 0; padding: 10px; overflow: hidden; pointer-events: auto;">
                <div style="display: flex; gap: 10px; margin-bottom: 8px;">
                    <button id="wb-start-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.7); border-radius: 5px; padding: 5px 14px; font-size: 11px; font-weight: 600; cursor: pointer; flex: 1; transition: all 0.2s;">生成</button>
                    <button id="wb-save-btn" style="background: rgba(76,29,149,0.7); color: #fff; border: 1px solid rgba(180,130,200,0.5); border-radius: 5px; padding: 5px 14px; font-size: 11px; font-weight: 600; cursor: pointer; flex: 1; opacity: 0.5; transition: all 0.2s;" disabled>保存</button>
                </div>
                <div id="wb-preview" style="max-height: 70px; overflow-y: auto; flex: 1;"></div>
            </div>
        `;
    },
    ...
    renderSummaryContent() {
        return `
            <div style="position: absolute; top: 30px; left: 0; right: 0; bottom: 0; padding: 10px; overflow: hidden; pointer-events: auto;">
                <button id="sum-start-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.7); border-radius: 5px; padding: 5px 14px; font-size: 11px; font-weight: 600; cursor: pointer; margin-bottom: 8px; width: 100%; transition: all 0.2s;">生成总结</button>
                <div id="sum-content" style="max-height: 70px; overflow-y: auto; flex: 1;"></div>
            </div>
        `;
    },
    ...
    renderAnalysisContent() {
        return `
            <div style="position: absolute; top: 30px; left: 0; right: 0; bottom: 0; padding: 10px; overflow: hidden; pointer-events: auto;">
                <button id="ana-start-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.7); border-radius: 5px; padding: 5px 14px; font-size: 11px; font-weight: 600; cursor: pointer; margin-bottom: 8px; width: 100%; transition: all 0.2s;">分析角色</button>
                <div id="ana-content" style="max-height: 70px; overflow-y: auto; flex: 1;"></div>
            </div>
        `;
    },
    ...
    renderSuggestionContent() {
        return `
            <div style="position: absolute; top: 30px; left: 0; right: 0; bottom: 0; padding: 10px; overflow: hidden; pointer-events: auto;">
                <button id="sug-start-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.7); border-radius: 5px; padding: 5px 14px; font-size: 11px; font-weight: 600; cursor: pointer; margin-bottom: 8px; width: 100%; transition: all 0.2s;">生成建议</button>
                <div id="sug-content" style="max-height: 70px; overflow-y: auto; flex: 1;"></div>
            </div>
        `;
    },
        ...
        appState.gen3Replies.forEach((reply, i) => {
            html += `
                <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(180,130,200,0.25); border-radius: 5px; padding: 7px; margin-bottom: 6px; display: flex; gap: 8px; align-items: flex-start;">
                    ...
                    <div style="flex: 1; font-size: 10.5px; color: rgba(255,255,255,0.9); line-height: 1.4;">${utils.escapeHtml(reply.substring(0, 90))}${reply.length > 90 ? '...' : ''}</div>
                    <div style="display: flex; gap: 4px;">
                        <button class="use-reply-btn" data-index="${i}" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.5); border-radius: 4px; padding: 3px 8px; font-size: 10px; font-weight: 600; cursor: pointer; transition: all 0.15s;">发</button>
                        <button class="copy-reply-btn" data-index="${i}" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.5); border-radius: 4px; padding: 3px 8px; font-size: 10px; font-weight: 600; cursor: pointer; transition: all 0.15s;">复</button>
                    </div>
                </div>
            `;
        });
    ...
    renderWorldbookEntry(entry) {
        ...
        previewEl.innerHTML = `
            <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(180,130,200,0.25); border-radius: 5px; padding: 8px;">
                ...
                <div style="font-size: 10.5px; color: rgba(255,255,255,0.88); line-height: 1.4;">${utils.escapeHtml(entry.content)}</div>
            </div>
        `;
    },
        ...
        if (type === 'analysis' && character) {
            html = `
                <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(180,130,200,0.25); border-radius: 5px; padding: 8px;">
                    ...
                    <div style="font-size: 10.5px; color: rgba(255,255,255,0.88); line-height: 1.45; margin-bottom: 7px;">${utils.escapeHtml(text)}</div>
                    <div style="display: flex;">
                        <button id="ana-copy-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.5); border-radius: 4px; padding: 4px 10px; font-size: 10px; font-weight: 600; cursor: pointer; width: 100%; transition: all 0.15s;">复制</button>
                    </div>
                </div>
            `;
        } else {
            html = `
                <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(180,130,200,0.25); border-radius: 5px; padding: 8px;">
                    ...
                    <div style="display: flex; gap: 8px;">
                        <button id="${type}-use-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.5); border-radius: 4px; padding: 4px 10px; font-size: 10px; font-weight: 600; cursor: pointer; flex: 1; transition: all 0.15s;">发送</button>
                        <button id="${type}-copy-btn" style="background: linear-gradient(135deg, #4c1d95, #7e22ce); color: #fff; border: 1px solid rgba(180,130,200,0.5); border-radius: 4px; padding: 4px 10px; font-size: 10px; font-weight: 600; cursor: pointer; flex: 1; transition: all 0.15s;">复制</button>
                    </div>
                </div>
            `;
        }
    ...
    showError(message, targetId) {
        ...
        if (el) {
            el.innerHTML = `
                <div style="font-size: 11px; color: rgba(248,113,113,0.95); padding: 8px; background: rgba(248,113,113,0.1); border-radius: 5px; border: 1px solid rgba(248,113,113,0.3);">
...
要求：每条回复简洁，60字以内，${genCount}条风格要有明显差异。`;
            ...
            if (typeof response === 'string') {
                ...
                if (appState.gen3Replies.length === 0) {
                    for (let i = 1; i <= genCount; i++) {
                        appState.gen3Replies.push(response.substring((i - 1) * 50, i * 50) || `回复${i}`);
                    }
                }
            }
    ...
    async generateAnalysis() {
        ...
        try {
            ...
            appState.analysisText = await api.safeGenerate(prompt, `${character.name}的性格分析...`);
            
            ui.renderTextContent('analysis', appState.analysisText);
            
        } catch (e) {
            utils.logError('Analysis failed', e);
            ui.showError('生成失败', 'ana-content');
        } finally {
            startBtn.disabled = false;
            startBtn.style.opacity = '1';
            ui.setLoading(false);
    ...
    async generateSuggestion() {
        ...
        try {
            ...
            appState.suggestionText = await api.safeGenerate(prompt, '情节发展建议...');
            
            ui.renderTextContent('suggestion', appState.suggestionText);
            
        } catch (e) {
            utils.logError('Suggestion failed', e);
            ui.showError('生成失败', 'sug-content');
        } finally {
            startBtn.disabled = false;
            startBtn.style.opacity = '1';
            ui.setLoading(false);
...
const events = {
    bindSVGEvents() {
        document.getElementById('btn-gen3')?.addEventListener('click', () => ui.renderDetailView('gen3'));
        document.getElementById('btn-worldbook')?.addEventListener('click', () => ui.renderDetailView('worldbook'));
        document.getElementById('btn-summary')?.addEventListener('click', () => ui.renderDetailView('summary'));
        document.getElementById('btn-analysis')?.addEventListener('click', () => ui.renderDetailView('analysis'));
        document.getElementById('btn-suggestion')?.addEventListener('click', () => ui.renderDetailView('suggestion'));
        document.getElementById('btn-back')?.addEventListener('click', () => ui.renderMainView());
        ...
        document.querySelectorAll('.svg-btn').forEach(btn => {
            btn.addEventListener('mouseenter', () => {
                const rect = btn.querySelector('rect, circle');
                if (rect) {
    ...
    bindOverlayEvents(tab) {
        switch(tab) {
            case 'gen3':
                document.getElementById('gen-start-btn')?.addEventListener('click', () => features.generate3Replies());
            ...
            case 'worldbook':
                document.getElementById('wb-start-btn')?.addEventListener('click', () => features.generateWorldbookEntry());
                document.getElementById('wb-save-btn')?.addEventListener('click', () => features.saveToWorldbook());
                break;
                
            case 'summary':
                document.getElementById('sum-start-btn')?.addEventListener('click', () => features.generateSummary());
                document.addEventListener('click', (e) => {
                    if (e.target.id === 'summary-use-btn' && appState.summaryText) {
                        chatManager.sendMessage(appState.summaryText);
                    }
                    if (e.target.id === 'summary-copy-btn' && appState.summaryText) {
            ...
            case 'analysis':
                document.getElementById('ana-start-btn')?.addEventListener('click', () => features.generateAnalysis());
                document.addEventListener('click', (e) => {
            ...
            case 'suggestion':
                document.getElementById('sug-start-btn')?.addEventListener('click', () => features.generateSuggestion());
                document.addEventListener('click', (e) => {
                    if (e.target.id === 'suggestion-use-btn' && appState.suggestionText) {
                        chatManager.sendMessage(appState.suggestionText);
                    }
                    if (e.target.id === 'suggestion-copy-btn' && appState.suggestionText) {
...
jQuery(async function() {
    ...
    if (sendForm.length) {
        ...
        utils.logInfo('Toolbar added to DOM');
    } else {
